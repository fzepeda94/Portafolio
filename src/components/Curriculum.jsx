...
export const Curriculum = () => {
  return (
    <Container className="my-5 py-5 animate__animated animate__fadeIn">
      {/* Título Principal */}
      <h1 className="display-4 fw-bold text-center text-primary mb-5 animate__animated animate__fadeInDown">
        Mi Trayectoria: <span className="text-secondary">Habilidades y Experiencia</span>
      </h1>

      {/* Sección de Experiencia Profesional */}
      <section className="mb-5 pb-4 border-bottom animate__animated animate__fadeInUp">
      ...
      <section className="mb-5 pb-4 border-bottom animate__animated animate__fadeInUp animate__delay-1s">
        <h2 className="fs-2 fw-bold text-dark mb-4 text-center">
      ...
      <section className="mb-5 pb-4 border-bottom animate__animated animate__fadeInUp animate__delay-1-5s">
        <h2 className="fs-2 fw-bold text-dark mb-4 text-center">
      ...
      <section className="mb-5 pb-4 border-bottom animate__animated animate__fadeInUp animate__delay-2s">
        <h2 className="fs-2 fw-bold text-dark mb-4 text-center">
      ...
      <section className="mb-5 pb-4 border-bottom animate__animated animate__fadeInUp animate__delay-2-5s">
        <h2 className="fs-2 fw-bold text-dark mb-4 text-center">
      ...
      {/* Sección Otros*/}
      <section className="animate__animated animate__fadeInUp animate__delay-3s">
        <h2 className="fs-2 fw-bold text-dark mb-4 text-center">
