...
export const Servicios = () => {
  return (
    <Container className="my-5 py-5 animate__animated animate__fadeIn"> {/* Contenedor principal para centrar y añadir padding, con animación */}
      ...
      <Row xs={1} md={2} lg={3} className="g-4 justify-content-center animate__animated animate__fadeInUp animate__delay-1s"> 
